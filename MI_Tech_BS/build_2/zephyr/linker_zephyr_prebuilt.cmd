...
MEMORY
    {
    FLASH (rx) : ORIGIN = 0x10000, LENGTH = 0xee000
    SRAM (wx) : ORIGIN = 0x20008000, LENGTH = 0x68000
   
   
   
   
    SRAM1(rw) : ORIGIN = 553648128, LENGTH = 65536
    ...
    IDT_LIST (wx) : ORIGIN = (0x20008000 + 0x68000), LENGTH = 2K
    }
ENTRY("__start")
SECTIONS
    {
